...
class Card
{
     ...
     * @ORM\ManyToOne(targetEntity="App\Model\Core\Entity\Deck\Deck", inversedBy="Cards")
     */
    private $deck;

    /**
     * @var Repeat
     * @ORM\Embedded(class="App\Model\Core\Entity\Card\Types\Repeat", columnPrefix="repeat_")
     * @Serializer\Groups({Card::GROUP_DETAILS})
     */
    private $repeat;
    ...
    /**
     * @var ArrayCollection
     * @ORM\OneToMany(targetEntity="App\Model\Core\Entity\Card\Types\Record", mappedBy="card", orphanRemoval=true, cascade={"persist"})
     */
    private $records;
    /**
     * @var ArrayCollection
     * @Serializer\SerializedName("frontSide")
     * @Serializer\Type(name="ArrayCollection<App\Model\Core\Entity\Card\Types\Record>")
