...
class Deck
{
    ...
    /**
     * @var Settings
     * @ORM\Embedded(class="App\Model\Core\Entity\Deck\Types\Settings", columnPrefix="settings_")
     * @Serializer\Groups({Deck::GROUP_DETAILS})
     */
    private $settings;
    /**
     * @var Learner
     * @ORM\ManyToOne(targetEntity="App\Model\Core\Entity\Learner\Learner", inversedBy="decks")
     * @ORM\JoinColumn(name="learner_id", referencedColumnName="id", nullable=false, onDelete="CASCADE")
     */
    private $learner;
    /**
     * @var ArrayCollection|null
     * @ORM\OneToMany(targetEntity="App\Model\Core\Entity\Card\Card", mappedBy="deck", orphanRemoval=true, cascade={"persist"})
