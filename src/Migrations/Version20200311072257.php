 ...
 */
final class Version20200311072257 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE record (id INT NOT NULL, card_id INT NOT NULL, value JSON NOT NULL, side SMALLINT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE card (id INT NOT NULL, deck_id INT NOT NULL, name VARCHAR(255) NOT NULL, date_next_repeat TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, date_created TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, date_last_modified TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, count_repeat INT NOT NULL, date_first_repeat TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_161498D3111948DC ON card (deck_id)');
        $this->addSql('CREATE TABLE deck (id INT NOT NULL, user_id INT NOT NULL, name VARCHAR(255) NOT NULL, description TEXT DEFAULT NULL, limit_repeat INT DEFAULT NULL, limit_learning INT NOT NULL, extra_learning INT NOT NULL, difficulty_index SMALLINT NOT NULL, base_index INT NOT NULL, modyfier_index INT NOT NULL, PRIMARY KEY(id))');
